      ...
      <GlassCard>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <select 
              id="categoria"
              className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3.5 text-text-main focus:outline-none focus:border-accent transition-colors appearance-none"
              value={categoria}
